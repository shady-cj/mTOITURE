            ...
            <main className="pt-[9.5rem] lg:pt-[11rem] flex flex-col lg:flex-row lg:gap-8 xl:gap-16">
                <div className="flex flex-col justify-between gap-[4rem]">
                    <div>
                        ...
                        <p className="w-fit mx-auto lg:mx-0 bg-[#EDEDFC] rounded-2xl border-[0.5px] border-solid border-[#9FC3CC] px-2 py-[3px] font-medium text-sm leading-4 text-[#48487F]">
                            {translations[lang][0]}
                        </p>
                        <h2 className="mt-3 mx-auto px-6 lg:px-0 lg:mx-0 font-semibold text-[#0E0E1A] text-[3.5rem] text-center lg:text-left leading-[4.2rem] max-w-[40rem]">
                        ...
                        <p className="font-normal text-center lg:text-left mx-auto lg:mx-0 text-base leading-7 mt-6 text-[#232324] max-w-[24rem] lg:max-w-[30rem]">
                            {translations[lang][4]}
                        </p>
                ...
                <div className="pt-[3.5rem] px-4 md:px-8 lg:pt-0 lg:px-0 lg:basis-[45%]">
                    ...
                    <div className="fixed translate-y-[-50%] md:translate-x-[50%] lg:translate-x-0 md:translate-y-[30%] flex gap-6 align-center bg-[#DDECF0] border border-solid border-[#A7D4E0] py-4 px-6 rounded-[26px] bottom-8 z-10 shadow-[-24px_-24px_48px_0px_#0000001F,24px_24px_48px_0px_#0000001F]">
                        <div className="">
                            <img src={fbHero} alt="" />
                        </div>
