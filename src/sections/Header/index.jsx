...
const Index = ({ setOpenQuote, lang }) => {
    return (
        <div className="fixed z-10 max-w-[inherit] top-[2.5rem] w-[inherit] px-4 lg:px-[5rem] xl:px-[7.5rem]" >
            <header className='relative w-[80vw] bg-[#0E0E1A] w-full rounded-[2rem] py-5 md:py-2 pr-3 pl-6 flex justify-between items-center'>
                ...
                {/* <nav className="flex flex-col items-center z-10 md:hidden absolute left-0 right-0 top-full">
                    <a href="#about" className="py-6">{translations[lang][0]}</a>
                    <a href="#gallery" className="py-6">{translations[lang][1]}</a>
                    <a href="#services" className="py-6">{translations[lang][2]}</a>
                    <a href="#reviews" className="py-6">{translations[lang][3]}</a>
                    <a href="#contact" className="py-6">{translations[lang][4]}</a>
